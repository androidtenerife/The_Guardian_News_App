...
public class ScienceFragment extends ArticleFragment {
    private static final String LOG_TAG = ScienceFragment.class.getName();

    @NonNull
    @Override
    public Loader<List<News>> onCreateLoader(int i, Bundle bundle) {
        String worldUrl = SharedPreferences.getPreferredUrl(getContext(), getString(R.string.science_frag).toLowerCase());
