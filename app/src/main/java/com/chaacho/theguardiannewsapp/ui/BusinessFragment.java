...
public class BusinessFragment extends ArticleFragment {
    private static final String LOG_TAG = "business";

    @NonNull
    @Override
    public Loader<List<News>> onCreateLoader(int i, Bundle bundle) {
        String businessUrl = SharedPreferences.getPreferredUrl(getContext(), getString(R.string.business).toLowerCase());
