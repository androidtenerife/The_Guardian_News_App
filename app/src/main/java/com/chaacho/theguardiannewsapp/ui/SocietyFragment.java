...
public class SocietyFragment extends ArticleFragment {
    private static final String LOG_TAG = SocietyFragment.class.getName();

    @NonNull
    @Override
    public Loader<List<News>> onCreateLoader(int i, Bundle bundle) {
        String worldUrl = SharedPreferences.getPreferredUrl(getContext(), getString(R.string.society).toLowerCase());
