...
public class FashionFragment extends ArticleFragment {
    private static final String LOG_TAG = FashionFragment.class.getName();

    @NonNull
    @Override
    public Loader<List<News>> onCreateLoader(int i, Bundle bundle) {
        String worldUrl = SharedPreferences.getPreferredUrl(getContext(), getString(R.string.fashion).toLowerCase());
